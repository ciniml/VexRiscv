...
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_M_AXI_LITE] [get_bd_intf_pins system_ila_cpu/SLOT_3_AXI] [get_bd_intf_pins xdma_0/M_AXI_LITE]
  ...
  connect_bd_net -net axi_intc_platform_irq [get_bd_pins axi_intc_platform/irq] [get_bd_pins system_ila_cpu/probe0] [get_bd_pins vexriscv_inst/externalInterrupt]
  ...
  connect_bd_net -net util_ds_buf_pcie_IBUF_DS_ODIV2 [get_bd_pins util_ds_buf_pcie/IBUF_DS_ODIV2] [get_bd_pins xdma_0/sys_clk_gt]
  connect_bd_net -net util_ds_buf_pcie_IBUF_OUT [get_bd_pins util_ds_buf_pcie/IBUF_OUT] [get_bd_pins xdma_0/sys_clk]
